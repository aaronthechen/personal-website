...
export default function Slider() {
  return (
    <div className='flex flex-row flex-wrap justify-evenly gap-8 w-full'>
      <ProjectCard title="SlapJack" tags={['Node.js', 'Socket.io']} link="https://github.com/aaronthechen/SlapJackGame">
      ...
      <ProjectCard title="Relayter" tags={['REST API', 'Front-end']} link="https://github.com/aaronthechen/relayter">
        A school project/game designed to help improve your vocabulary through related words, generated by the Datamuse API.
      </ProjectCard>
      <ProjectCard title="Software Supply Chain Attacks" tags={['Research', 'Cybersecurity']} link="https://github.com/aaronthechen/software-supply-chain-attack-tools">
        A survey paper detailing a comprehensive recount of software supply chain attacks.
      </ProjectCard>
      <ProjectCard title="Personal Website" tags={['React', 'Tailwind']} link="https://github.com/aaronthechen/personal-website">
